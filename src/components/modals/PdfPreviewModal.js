...
//   // ✅✅✅ NEW: store local preview url for iframe (blob URL safe)
...
//   // ✅✅✅ NEW: whenever modal opens, set previewUrl
//   useEffect(() => {
//     if (!open) return;

//     // Priority: saved report url > incoming pdfUrl
//     const finalUrl = getPdfUrl(currentReport, title) || pdfUrl;

//     if (finalUrl) {
//       setPreviewUrl(finalUrl);
//     }
//   }, [open, pdfUrl, currentReport, title]);

//   // ✅✅✅ NEW: revoke blob URL when modal closes (memory leak fix)
//   useEffect(() => {
//     return () => {
...
//   // ===========================
//   // ✅ Signature Preview Builder
//   // ===========================
//   useEffect(() => {
//     if (currentReport && currentReport[0]?.reportingRemarks) {
//       const actualWard =
//         currentReport[0]?.ward || wardName || user?.ward || "Unknown Ward";

//       const signatures = [
//         {
//           role: "Lipik:",
//           status: currentReport[0]?.reportingRemarks?.find((r) => r.role === "Lipik")
//             ? "verified"
//             : "unverified",
//           ward: actualWard,
//           month: monthpassbackend || "MAR-2025",
//           date: new Date().toLocaleDateString(),
//           signature:
//             currentReport[0]?.reportingRemarks?.find((r) => r.role === "Lipik")
//               ?.signature || "",
//         },
//         {
//           role: "Junior Engineer:",
//           status: currentReport[0]?.reportingRemarks?.find(
//             (r) => r.role === "Junior Engineer" && r.ward !== "Head Office"
//           )
//             ? "verified"
//             : "unverified",
//           ward: actualWard,
...
//           date: new Date().toLocaleDateString(),
//           signature:
//             currentReport[0]?.reportingRemarks?.find((r) => r.role === "Junior Engineer")
//               ?.signature || "",
//         },
//         {
//           role: "Junior Engineer:",
...
//           date: new Date().toLocaleDateString(),
//           signature:
//             currentReport[0]?.reportingRemarks?.find(
//               (r) => r.role === "Junior Engineer" && r.ward === "Head Office"
//             )?.signature || "",
//         },
//         {
//           role: "Accountant:",
//           status: currentReport[0]?.reportingRemarks?.find((r) => r.role === "Accountant")
//             ? "verified"
//             : "unverified",
//           ward: actualWard,
//           month: monthpassbackend || "MAR-2025",
//           date: new Date().toLocaleDateString(),
//           signature:
//             currentReport[0]?.reportingRemarks?.find((r) => r.role === "Accountant")
//               ?.signature || "",
//         },
//         {
//           role: "Assistant Municipal Commissioner:",
//           status: currentReport[0]?.reportingRemarks?.find(
//             (r) => r.role === "Assistant Municipal Commissioner"
//           )
//             ? "verified"
//             : "unverified",
//           ward: actualWard,
...
//           role: "Dy Municipal Commissioner:",
//           status: currentReport[0]?.reportingRemarks?.find(
//             (r) => r.role === "Dy.Municipal Commissioner"
//           )
//             ? "verified"
//             : "unverified",
//           ward: actualWard,
...
//   const handleDownload = async () => {
//     try {
//       // ✅ NEW: always use previewUrl (blob safe)
//       const currentPdfUrl = previewUrl;
...
//       const link = document.createElement("a");
//       link.href = currentPdfUrl;
//       link.download = `${title || "download"}_${monthpassbackend || ""}.pdf`;
//       link.click();

//       // ✅ optional signature pdf
//       if (title === "form22" || title === "karyalayintipani" || title === "wardbilllist") {
//         setTimeout(async () => {
//           try {
//             if (signaturesData && signaturesData.length > 0) {
...
//       // ✅✅✅ NEW: save previewUrl pdf (not old pdfUrl)
...
//   // ===========================
//   // ✅ Fetch Report for month
//   // ===========================
//   useEffect(() => {
//     if (monthpassbackend && user?.ward && open) {
//       const fetchReport = async () => {
//         const finalWard = user.ward === "Head Office" ? wardName : user.ward;
...
//       fetchReport();
//     }
//   }, [monthpassbackend, user?.ward, wardName, open]);

//   // ✅✅✅ NEW: made function outside also used above
//   function getPdfUrl(reportData, formType) {
//     if (!reportData) return null;

//     const lipikRemark = reportData[0]?.reportingRemarks?.find((remark) => remark.role === "Lipik");

//     if (lipikRemark) {
//       const document = lipikRemark.documents?.find((doc) => doc.formType === formType);
...
//   const pdfUrlnew = getPdfUrl(currentReport, title);
...
//               <iframe
//                 src={previewUrl || pdfUrlnew || pdfUrl}
//                 style={{ width: "100%", height: "100%", border: "none" }}
//                 title="PDF Preview"
//               />
//             </Box>
